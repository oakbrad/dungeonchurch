...
const lights = {
    ...
    candle: {
        label: "Candle",
        data: {dim: 10, bright: 5, angle: 360, animation: torchAnimation}
    },    
    torch: {
        label: "Torch",
...
//    },
    lantern: {
        label: "Lantern",
        data: {dim: 60, bright: 30, angle: 360, animation: torchAnimation}
    },
    hooded: {
        label: "Hooded Lantern",
        data: {dim: 5, bright: 0, angle: 360, animation: torchAnimation}
    },
    bullseye: {
